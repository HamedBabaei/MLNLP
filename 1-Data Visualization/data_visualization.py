...
def bar(x , y , xlabel = 'X', ylabel = 'Y', title = "Bar Plot"):
    '''
    Drawing a BAR plot
    Example of usage:
...
def barh(x , y , xlabel = 'X', ylabel = 'Y', title = "Barh Plot"):
    '''
    Drawing a Barh plot
    Example of usage:
    >>> import data_visualization as dv
...
def scatter(x , y, colors, xlabel = 'X', ylabel = 'Y', title = "Scatter Plot"):
    '''
...
def hist( data , legend_loc = 'best', labels = {}, xlabel = 'X', ylabel = 'Y', title = "Hist Plot"):
    '''
    Drawing a Hist plot
    Example of usage:
    >>> x = np.random.normal(size = 100)
...
def distplot(x , hist = True , xlabel = 'X', ylabel = 'Y', title = "Univariate Distribution Plot"):
    '''
...
def kdeplot(x , x2, shade = True , xlabel = 'X', ylabel = 'Y', title = "Kernel Density Estimation Plot"):
    '''
...
def jointplot(x , y , data , kind = 'hex' , shade = False, xlabel = 'X', 
                ylabel = 'Y', title = ""):
    '''
    Joint plot
    Usage example:
